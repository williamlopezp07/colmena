        ...
        <div class="modal-content">
            ...
            <form id="formMantto">
                ...
                <div class="row ">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        ...
                        <input type="text" class="form-control" name="codigo" value="" max="100" placeholder="Si es influencer, especificar el handle" required>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-12">
                        ...
                        <input type="hidden" class="form-control" name="tipo_accion" value=""  required>
                        <input type="text" class="form-control" name="descripcion" value="" placeholder="Si es influencer, especificar el nombre completo" max="100" required>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-12">
              ...
              <div class="modal-footer">
                <button class="btn btn-secondary" type="submit" id="actualizar_codigo">Guardar</button>
              </div>
          </div>
            </form>
      </div>
