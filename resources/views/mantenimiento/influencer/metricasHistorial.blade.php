<div id="MetricaHistorialInfluencer">
          ...
          <?php if (strpos($key1->input, "general") !== false): ?>
            ...
            <?php if (strpos($key1->input, "edad_") !== false): ?>
              <div class="col-md-<?php echo $col ?>">
                ...
                <?php if ($key1->type_input=='text' or $key1->type_input=='number'): ?>
                  <input type="{{$key1->type_input}}" class="form-control form-control-sm" name="{{$key1->input}}" <?php $key1->type_input=='number'? ' step="any"' :'step="any"' ?> value="" readonly>
                <?php endif; ?>
              </div>
            <?php endif; ?>
          <?php endif; ?>
        ...
        <?php foreach (json_decode($key->json_demografica) as $key1): ?>
            ...
            <?php if (strpos($key1->input, "ciudad_") !== false): ?>
              <div class="col-md-<?php echo $col ?>">
                <label for="" style="font-size:9pt">{{$key1->descripcion}} </label>
                <?php if ($key1->type_input=='text' or $key1->type_input=='number'): ?>
                  <input type="{{$key1->type_input}}" class="form-control form-control-sm" name="{{$key1->input}}"  <?php $key1->type_input=='number'? ' step="any"' :'' ?>value="" readonly>
                <?php endif; ?>
              </div>
            <?php endif; ?>
        <?php endforeach; ?><br>
          ...
          <?php if ($key1->valor=='tarifario'): ?>
            <div class="col-md-6">
              ...
              <?php elseif($key1->type_input=='array'): ?>
                <input type="text" class="form-control form-control-sm array_prom" name="{{$key1->input}}" value="" readonly>
              <?php elseif($key1->type_input=='er'): ?>
                <input type="number" class="form-control form-control-sm er" name="{{$key1->input}}" value="" readonly>
              <?php elseif($key1->type_input=='castigo'): ?>
                <input type="number" class="form-control form-control-sm castigo" name="{{$key1->input}}" min="0" max="100" step="any" value="100" readonly>
            <?php endif; ?>
            </div>
          <?php endif; ?>
        <?php endforeach; ?>
  ...
  <script type="text/javascript">
    ...
    metricasEdit.forEach(element =>
      (element[0].metricas).forEach( val =>
      $('#MetricaHistorialInfluencer #'+element[0].red_social).find('[name='+val.input+']').val(val.valor)
    )
  );
  activate_tooltip()
