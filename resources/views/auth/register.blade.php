            ...
            <div class="card shadow-lg border-0 rounded-lg mt-5">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="producto" class="col-md-4 col-form-label text-md-end">{{ __('Producto') }}</label>
                            <div class="col-md-6">
...
<script type="text/javascript">
  ...
  $.ajax({
    ...
    success: function(data){
      data.forEach((item, i) => {
        $('#rol').append("<option value='"+item.id+"'>"+item.name+"</option>")
      });
    }
  })
  $.ajax({
    ...
    success: function(data){
      $('#producto').append("<option value=''>Ninguno</option>")
      data.forEach((item, i) => {
        $('#producto').append("<option value='"+item.id+"'>"+item.cliente_name+" - "+item.producto+"</option>")
      });
    }
  })
</script>
