function loadData(){
    $('#consulta').DataTable({
        ...
        iDisplayLength: 10,
        ajax:{
            url:baseurl+'/mantenimiento/categoria_redsocial/',
            type:'GET',
        },
        columns:[
          {data:'id'},
...
$(document).on('submit','#formMantto',function(e){
  ...
  const form = $(this)
  $.ajax({
    url: baseurl + '/mantenimiento/categoria_redsocial/store',
    type: 'POST',
    data: form.serialize(),
    beforeSend: function(){
      swal({
...
$(document).on('click','.btn-editar',function(e){
  ...
  $.ajax({
    url: baseurl + '/mantenimiento/categoria_redsocial/edit',
    type: 'get',
    data: {id:id},
    success: function(data){
      console.log(data.error)
...
$(document).on('click','.btn-eliminar',function(e){
  ...
  swal({
    ...
    function(){
      $.ajax({
        url:baseurl+'/mantenimiento/categoria_redsocial/destroy',
        type:'GET',
        data:{
          'id':id
        },
